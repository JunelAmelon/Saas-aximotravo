...
import {
  getRecentProjectsByCourtier,
  getCourtierProjectStats,
  Project,
} from "@/lib/firebase/projects";
import {
  getRecentActivitiesByCourtier,
  ...
  useEffect(() => {
    async function loadDashboardData() {
      ...
      try {
        ...
        try {
          recentProjects = await getRecentProjectsByCourtier(
            currentUser.uid,
            5
          );
        } catch (err) {
        ...
        try {
          recentActivities = await getRecentActivitiesByCourtier(
            currentUser.uid,
            10
          );
        } catch (err) {
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {projects.length > 0 ? (
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden h-auto lg:h-[400px] flex flex-col relative">
                ...
                <div className="relative p-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h3 className="text-base font-bold text-[#f26755]">
                        Projets en cours
                      </h3>
                            ...
                            <td className="px-2 py-1 whitespace-nowrap">
                              <span
                                className={`inline-flex items-center px-1.5 py-0.5 rounded-full text-[10px] font-medium border ${
                                  statusConfig[project.status as StatusKey]
                                    ?.className ||
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200 text-center h-auto lg:h-[400px] flex flex-col justify-center">
                ...
                <button
                  onClick={() => handleNavigation("/courtier/projects/new")}
                  className="group px-4 py-2 bg-[#f26755] text-white rounded-lg 
             hover:bg-[#f26755]/90 transition-all duration-300 
             font-medium shadow-md hover:shadow-lg text-sm 
             inline-flex items-center gap-1 mx-auto"
                >
                  ...
                  <div className="text-center py-8 space-y-4">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-900 mb-2 text-base">
                        Aucun artisan associé
                      </h3>
                      <p className="text-sm text-gray-600">
                        Ajoutez des artisans à votre équipe
                      </p>
                    </div>
                    <button
                      onClick={() => handleNavigation("/courtier/artisans")}

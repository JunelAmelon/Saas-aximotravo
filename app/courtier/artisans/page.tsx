...
<div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
  {/* Bouton Retour - toujours visible mais réorganisé */}
  <button
    onClick={() => router.push('/courtier/dashboard')}
    className="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-lg transition-colors self-start sm:self-center"
  >
    Retour
  </button>
  
  {/* Titre - centré sur mobile, normal sur desktop */}
  <h1 className="text-2xl font-bold text-gray-900 text-center sm:text-left order-first sm:order-none">
    Gestion des artisans
  </h1>
  
  {/* Bouton Ajouter - en dessous sur mobile, à droite sur desktop */}
  <button
    onClick={() => setOpenAddModal(true)}
    className="flex items-center justify-center gap-2 px-4 py-2 bg-[#f26755] text-white rounded-md font-semibold shadow hover:opacity-90 transition-colors disabled:opacity-50 self-end sm:self-center w-full sm:w-auto"
  >

...
// Liste de toutes les collections à exporter (constante globale)
const COLLECTIONS = [
  'users',
  'projects', 
  'payments',
      ...
      for (const collectionName of COLLECTIONS) {
        try {
          ...
          querySnapshot.forEach((doc) => {
            ...
            const processedData: Record<string, any> = { id: doc.id, ...docData };
            Object.keys(processedData).forEach((key: string) => {
